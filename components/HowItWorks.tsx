const steps = [
  ...
  { number: "03", title: "Get a focused roadmap", text: "Receive a score, the work that already stands out, and practical next moves." },
];

export default function HowItWorks() {
  return (
    <section className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 animate-fade-in-up" id="how-it-works">
