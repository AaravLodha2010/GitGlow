export default function Navbar() {
  return (
    <header className="relative z-20 mx-auto flex h-20 w-full max-w-7xl items-center justify-between px-6 lg:px-8">
      <a href="#" className="group flex items-center gap-2.5" aria-label="GitGlow home">
      ...
      <nav className="hidden items-center gap-8 text-sm text-zinc-400 md:flex" aria-label="Main navigation">
        <a className="transition-colors hover:text-zinc-100" href="#features">Features</a>
        <a className="transition-colors hover:text-zinc-100" href="#how-it-works">How It Works</a>
        <a className="transition-colors hover:text-zinc-100" href="#pricing">Pricing</a>
      </nav>

      <a href="#get-started" className="rounded-full bg-zinc-100 px-4 py-2.5 text-xs font-semibold text-zinc-950 transition duration-300 hover:bg-[#d7ff54] hover:shadow-[0_0_24px_rgba(215,255,84,0.16)] sm:px-5 sm:text-sm">
        Analyze My GitHub
      </a>
    </header>
  );
