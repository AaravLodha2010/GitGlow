    ...
    <section className="relative mx-auto max-w-7xl px-6 pb-20 pt-20 text-center sm:pb-28 sm:pt-28 lg:px-8 lg:pt-32" id="hero">
      ...
      <div className="relative z-10 mx-auto max-w-4xl">
        <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-zinc-800 bg-zinc-900/70 px-3 py-1.5 text-xs font-medium text-zinc-400 backdrop-blur">
          <span className="size-1.5 rounded-full bg-[#d7ff54] shadow-[0_0_8px_#d7ff54]" />
          Built for ambitious developers
        </div>
        <h1 className="text-balance text-5xl font-semibold tracking-[-0.065em] text-zinc-50 sm:text-6xl lg:text-8xl lg:leading-[0.98]">
          Turn your GitHub into your <span className="text-[#d7ff54]">strongest resume.</span>
        </h1>
