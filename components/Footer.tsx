export default function Footer() {
  return (
    <footer className="mx-auto w-full max-w-7xl px-6 pb-8 pt-16 lg:px-8" id="pricing">
      <div className="flex flex-col items-start justify-between gap-8 border-b border-zinc-800 pb-12 sm:flex-row sm:items-end">
        ...
        <a id="get-started" href="#" className="text-sm font-medium text-zinc-300 transition hover:text-[#d7ff54]">Analyze My GitHub <span aria-hidden="true">→</span></a>
      </div>
      <div className="flex flex-col gap-3 py-6 text-xs text-zinc-600 sm:flex-row sm:items-center sm:justify-between"><span>© 2026 GitGlow. Built for developers.</span><div className="flex gap-5"><a href="#" className="transition hover:text-zinc-300">Privacy</a><a href="#" className="transition hover:text-zinc-300">Terms</a></div></div>
    </footer>
  );
}
